...
evidence_data = [
{“Date”: “2006”, “Action”: “GCNY LLC Created”, “Status”: “✅ Both Bridge & Leila as managers”, “Fraud Level”: “None”},
...
st.markdown(”—”)
st.error(f”🚨 **BRIDGE SITS ON ${total_assets_with_commingled:,.0f}+ COURT-DOCUMENTED ASSETS AND OFFERS $779/MONTH - THIS IS CRIMINAL THEFT!** 🚨”)
